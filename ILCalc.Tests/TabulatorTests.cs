...
namespace ILCalc.Tests
{
  ...
  public sealed class TabulatorTests
  {
    ...
    delegate T EvalFunc3<T>(
      T arg1, T arg2, T arg3);

    delegate double EvalFunc4<T>(
      T arg1, T arg2, T arg3, T arg4);

    static double[] Tabulate1D(
      EvalFunc1<double> func,
    ...
    static double[][] Tabulate2D(
      EvalFunc2<double> func,
      ValueRange<double> r1,
      ValueRange<double> r2)
    {
    ...
    static double[][][] Tabulate3D(
      EvalFunc3<double> func,
      ValueRange<double> r1,
      ValueRange<double> r2,
      ValueRange<double> r3)
    {
    ...
    static double[][][][] Tabulate4D(
      EvalFunc4<double> func,
      ValueRange<double> r1,
      ValueRange<double> r2,
      ValueRange<double> r3,
      ValueRange<double> r4)
    {
    ...
    static ValueRange<double> GetRandomRange()
    {
    ...
    public void TabulatorTest1D()
    {
      ...
      var tab = calc.CreateTabulator("2sin(x)");
    ...
    public void TabulatorTest2D()
    {
      ...
      var rangeX = GetRandomRange();
      var rangeY = GetRandomRange();

      var tab = calc.CreateTabulator("cos(x) * sin(y)");
      var async = tab.BeginTabulate(rangeX, rangeY, null, null);
    ...
    public void TabulatorTest3D()
    {
      ...
      var tab = calc.CreateTabulator("cos(x) * sin(y) * tan(z)");
      var async = tab.BeginTabulate(
    ...
    {
      var calc = new CalcContext<double>("x", "y", "z", "w");
      calc.Functions.Add(Math.Sin);
      calc.Functions.Add(Math.Cos);
      calc.Functions.Add(Math.Tan);
    ...
    public void InterpretTest1D()
    {
      ...
      var tab = calc.CreateInterpret("2sin(x)");
      var async = tab.BeginTabulate(range, null, null);
    ...
    public void InterpretTest2D()
    {
      ...
      var rX = GetRandomRange();
      var rY = GetRandomRange();

      var tab = calc.CreateInterpret("cos(x) * sin(y)");
      IAsyncResult async =
    ...
    public void InterpretTest3D()
    {
      ...
      var tab = calc.CreateInterpret("cos(x) * sin(y) * tan(z)");
      var async = tab.BeginTabulate(rangeX, rangeY, rangeZ, null, null);
    ...
    public void InterpretTest4D()
    {
      ...
      var tab = calc.CreateInterpret("cos(x) * sin(y) * tan(z) * sin(w)");
      var async = tab.BeginTabulate(new[] { rX, rY, rZ, rW }, null, null);
